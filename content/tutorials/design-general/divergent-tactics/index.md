...
**Imagining a situation**. Imagine yourself in a situation that calls for the app that you are designing. Think systematically through what you might be doing, and simulate your application ideas in your mind’s eye.
...
**Gap analysis**. Consider existing apps and the gaps between the features they offer and needs you have identified. 
...
**Differing abilities**. Different users have different physical abilities, and a software design should accommodate these whenever possible.
...
**Considering children**. An app designer should remember that even apps that are not designed with children in mind can end up being used by children.
...
**Diverse geographies**. A solution designed for one geographic setting may perform quite differently in another.
