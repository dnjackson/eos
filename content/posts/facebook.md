...
(Twitter, by the way, works differently: replies are seen as being published independently, so they are shown to the follows of the replier, not to followers of the original poster.)
